...
const uint64_t MONEY_SUPPLY                                  = UINT64_C(98589869056000000000000000000000) ;
...
const size_t   CRYPTONOTE_COINBASE_BLOB_RESERVED_SIZE        = 6000;
...
const char     CRYPTONOTE_NAME[]                             = "Zoltinote";
